...
app.controller('createConfigurationCtrl', function ($scope, $routeParams, $location, $http) {
    ...
    $scope.save = function () {
        $http.post('api/configurations/create', { applicationId: $scope.configuration.applicationId, environmentId: $scope.configuration.environmentId == 0 ? null : $scope.configuration.environmentId, name: $scope.configuration.name, type: $scope.configuration.type, value: $scope.configuration.value })
            .then(function (response) {
                if (response.data.isSuccessful === false) {
                    alert(response.data.message);
                } else {
...
app.controller('editConfigurationCtrl', function ($scope, $routeParams, $location, $http) {
    ...
    $scope.save = function () {
        ...
        $http.post('api/configurations/edit', { id: $routeParams.id, applicationId: environment.applicationId, environmentId: $scope.configuration.environmentId == 0 ? null : $scope.configuration.environmentId, name: $scope.configuration.name, type: $scope.configuration.type, value: $scope.configuration.value })
            .then(function (response) {
                if (response.data.isSuccessful === false) {
                    alert(response.data.message);
                } else {
